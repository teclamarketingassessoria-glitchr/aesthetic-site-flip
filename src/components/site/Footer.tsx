...
import logoCarckiWhite from "@/assets/logo-carcki-wordmark-white.png";
import logoDeceuninck from "@/assets/logo-deceuninck-white.png";
import logoCarckiRound from "@/assets/logo-carcki-round-nobg.png";
      ...
      <div className="container-x py-20 grid gap-16 md:grid-cols-12 relative">
        <div className="md:col-span-5 space-y-6">
          <div className="flex items-center gap-3">
            <img src={logoCarckiRound} alt="Carcki" className="h-10 w-10" />
            <span className="text-white font-bold text-2xl tracking-[0.15em]">CARCKI</span>
          </div>
          ...
          <div className="pt-4 border-t border-background/10 max-w-xs">
            ...
            <div className="relative overflow-hidden" style={{ height: '30px' }}>
              <img src={logoDeceuninck} alt="Deceuninck" style={{ position: 'absolute', height: '340px', width: 'auto', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', opacity: 0.9 }} />
            </div>
          </div>
        </div>
        ...
        <div className="md:col-span-4 space-y-5">
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="tel:+5547992140321" className="text-background/80 hover:text-background">+55 47 9214-0321</a>
            </li>
            <li className="flex items-center gap-3">
